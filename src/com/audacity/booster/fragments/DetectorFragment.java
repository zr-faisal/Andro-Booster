...
import com.audacity.booster.utils.Detector.AdSource;
import com.audacity.booster.utils.Detector.AdSourcesInfo;
import com.audacity.booster.utils.NativeDetectionDialogFragment;
	...
	private void populate(AdSourcesInfo adSources) {
		if (adSources == null) {
			...
			if (adSources.adSources.isEmpty()) {
				Toast.makeText(getActivity(), "Congratulations! No virus found!", Toast.LENGTH_SHORT).show();
			}
		}
	}
